...
CMD [ "python", "src/petals/cli/run_server.py", "bigscience/bloom-560m", "--num_blocks", "24", "--initial_peers", "/ip4/172.28.5.2/tcp/9000/p2p/QmaFMcNeEjz7U8AeqF6euSFZz4c1LAyuJhpYAf7DtPJkHs", "--malicious", "True" ]
